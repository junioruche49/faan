        ...
        <div class="d-flex align-items-center">
          ...
          <div class="dropdown pull-right hidden-md-down">
            <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <img src="<?php echo url('assets/img/profiles/avatar.jpg') ?>" alt="" data-src="<?php echo url('assets/img/profiles/avatar.jpg') ?>" data-src-retina="<?php echo url('assets/img/profiles/avatar.jpg') ?>" width="32" height="32">
              </span>
            </button>
            <div class="dropdown-menu dropdown-menu-right profile-dropdown" role="menu">
              ...
              <a href="<?php echo url('index.php') ?>" class="clearfix bg-master-lighter dropdown-item">
