...
<style>
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-success" data-toggle="modal" data-target="#airport">View</button>
                                        </td>
            ...
            <!-- New Resident Modal -->
            <div class="modal fade" id="airport" tabindex="-1" role="dialog" aria-labelledby="airport" aria-hidden="true">
                <div class="modal-dialog modal-xlg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                        <label>Airport Name</label>
                                          <input type="text" class="form-control" value="Murtala Muhammed International Airport">
                                      </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group form-group-default">
...
Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                            <button type="button" class="btn btn-primary">Updat Airport</button>
                        </div>
                    </div>
                </div>
            </div>
